...
- Evaluation results, with fancy graphs:
  - R: `[Broken link] https://github.com/UPPMAX/R-matlab-julia-HPC/tree/main/docs/evaluations/20250324_r`
  - MATLAB: `[Broken link] https://github.com/UPPMAX/R-matlab-julia-HPC/tree/main/docs/evaluations/20250325_matlab`
  - Julia: `[Broken link] https://github.com/UPPMAX/R-matlab-julia-HPC/tree/main/docs/evaluations/20250326_julia`
  - All 3 courses combined: `[Broken link] https://github.com/UPPMAX/R-matlab-julia-HPC/tree/main/docs/evaluations/202503_courses`
...
- [Richel] I think we should pick the MkDocs **theme most of us like**:
      - materials (e.g. [NAISS File Transfer](https://hpc.pages.naiss.se/training/connect-transfer/)):  RB

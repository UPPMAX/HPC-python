...
source /proj/spring-courses-naiss/numba-gpu/bin/activate 
# or else comment out the above line and you can create it with the following steps: 
# cd /proj/spring-courses-naiss/users/<mydir>
...
# source /proj/spring-courses-naiss/users/<mydir>/numba-gpu/bin/activate

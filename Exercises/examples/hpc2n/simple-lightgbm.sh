...
cd /proj/nobackup/hpc-python-spring/<mydir-name>/HPC-python/Exercises/examples/programs/
...
source /proj/nobackup/hpc-python-spring/<mydir-name>/<path-to-my-venv>/vpyenv/bin/activate

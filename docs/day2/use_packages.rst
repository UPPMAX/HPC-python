...
.. admonition:: Answer: where is this documented?
    ...
    +------------+----------------------------------------------------------------------------------------------------------------------------------------------+
    | Pelle      |`Python <https://docs.uppmax.uu.se/software/python_pelle/>`__ & `Python bundles <https://docs.uppmax.uu.se/software/python_bundles/>`__       |
    +------------+----------------------------------------------------------------------------------------------------------------------------------------------+

...
cd /proj/nobackup/hpc-python-fall-hpc2n/<mydir-name>/HPC-python/Exercises/examples/programs/
...
source /proj/nobackup/hpc-python-fall-hpc2n/<mydir-name>/<path-to-my-venv>/vpyenv/bin/activate

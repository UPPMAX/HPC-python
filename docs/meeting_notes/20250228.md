...
- FYI, Day 2, hours 1 and 2 (about modules, packages and virtual environments): RB and BC will be co-teaching, inspired by [this paper](https://pmc.ncbi.nlm.nih.gov/articles/PMC10074276/) which is the next read in [the SciLifeLab Teaching Literature Club](https://scilifelab.github.io/teaching_literature_club/). Progress is slow, but steady
